...
def df_write_github_languages_in_mysql(mysql_credentials,df):
    ...
    df.to_sql(con=engine, name='github_languages', if_exists='replace')
...
def main():
    ...
    df_write_github_languages_in_mysql(mysql_credentials,df)
    return 0
